...
public final class ConfigManager {
    ...
    public void loadAll() {
        ...
        shopItemsConfig.setFile(new File(plugin.getDataFolder(), "shop-items.yml"));
        ...
        messagesConfig = new MessagesConfig(plugin, mainConfig.getString("locale", "id_ID"), loadYaml("messages.yml"));
    ...
    /** Reloads only shop.yml, preserving the live ShopItemsConfig instance used by ShopManager. */
    public void reloadShopConfigOnly() {
        shopConfig = new ShopConfig(loadYaml("shop.yml"));
    }
