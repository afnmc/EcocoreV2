...
public final class ShopConfig {
     ...
     */
    public record CategoryDefinition(String id, String displayName, String icon, int slot, String iconData) {
    }
    ...
    public ShopConfig(FileConfiguration config) {
        ...
        for (var raw : config.getMapList("categories")) {
            ...
            Object iconData = raw.get("icon-data");
            categories.add(new CategoryDefinition(id, displayName, icon, slot,
                    iconData == null ? "" : String.valueOf(iconData)));
        }
