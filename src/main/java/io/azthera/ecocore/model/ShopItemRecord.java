...
public final class ShopItemRecord {
    ...
    /** Optional Base64 Bukkit serialization of the exact admin-selected ItemStack. */
    ...
    private Double customSellPrice = null;
    ...
    public double getSellPrice() {
        if (customSellPrice != null && customSellPrice >= 0) {
            return customSellPrice;
        }
        return Math.max(0.0, currentPrice * 0.88);
    }
