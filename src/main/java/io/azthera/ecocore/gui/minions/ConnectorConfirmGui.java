...
/**
 * "Save this connection?" confirmation screen shown after a player
 * picks a source and destination minion with the Connector Tool (see
 * {@code listener.MinionInteractListener}). Nothing is persisted
 * until the player explicitly confirms here.
 */
public final class ConnectorConfirmGui extends AbstractGui {
    ...
    /**
     * Creates the connector confirmation screen.
     *
     ...
     * @param source           the selected source minion
     * @param destination      the selected destination minion
     */
