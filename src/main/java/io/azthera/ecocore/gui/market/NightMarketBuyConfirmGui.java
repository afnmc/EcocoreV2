...
public final class NightMarketBuyConfirmGui extends AbstractGui {
    ...
    @Override
    public void build() {
        inventory = Bukkit.createInventory(this, 27, messagesConfig.get("ui.market.confirm-title"));
        ...
        if (infoMeta != null) {
            infoMeta.setDisplayName(messagesConfig.get("ui.market.buy-question", "item", offerId));
            infoMeta.setLore(List.of(messagesConfig.get("ui.market.confirm-price", "price", String.format("%.2f", price))));
