...
public final class SellConfirmGui extends AbstractGui {
    ...
    @Override
    public void build() {
        inventory = Bukkit.createInventory(this, 27, messagesConfig.get("ui.sell.confirm-title"));
        ...
        if (infoMeta != null) {
            infoMeta.setDisplayName(messagesConfig.get("ui.sell.confirm-question", "target", targetLabel));
            infoMeta.setLore(List.of(messagesConfig.get("ui.sell.confirm-lore")));
