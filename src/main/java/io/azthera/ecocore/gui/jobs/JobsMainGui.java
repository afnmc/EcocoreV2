...
public final class JobsMainGui extends AbstractGui {
    ...
    @Override
    public void build() {
        inventory = Bukkit.createInventory(this, guiConfig.getJobsMainRows() * 9, messagesConfig.get("ui.jobs.title"));
        render();
    }
        ...
        if (meta != null) {
            ...
            try {
                ...
                if (progress != null) {
                    ...
                    meta.setLore(List.of(messagesConfig.get("ui.jobs.not-joined"), messagesConfig.get("ui.jobs.join")));
                }
            } catch (SQLException exception) {
                meta.setLore(List.of(messagesConfig.get("ui.jobs.load-failed")));
            }
    ...
    public void handleClick(InventoryClickEvent event) {
        ...
        try {
            ...
            viewer.sendMessage(messagesConfig.getWithPrefix("ui.jobs.join-failed"));
            return;
        }
