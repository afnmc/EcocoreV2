...
public abstract class AbstractGui implements InventoryHolder {
     ...
     * slots back a live data object (e.g. a container's storage) should
    ...
    public void open() {
        try {
            ...
            viewer.sendMessage(io.azthera.ecocore.EcoCorePlugin.getInstance().getMessagesConfig().getWithPrefix("ui.common.error-open"));
            return;
        }
        ...
        if (inventory == null) {
            ...
            viewer.sendMessage(io.azthera.ecocore.EcoCorePlugin.getInstance().getMessagesConfig().getWithPrefix("ui.common.error-open-short"));
            return;
        }
