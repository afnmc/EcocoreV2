...
public final class EcoCorePlugin extends JavaPlugin {
    ...
    private void registerListeners() {
        ...
        pluginManager.registerEvents(new io.azthera.ecocore.listener.JobPlantListener(jobsManager, inflationEngine, inflationConfig), this);
    }
    ...
    private void registerCommands() {
        ...
        setExecutor("ecoadmin", new io.azthera.ecocore.commands.EcoAdminCommand());
