 ...
 *
 * <p>No longer attempts player-level auto-sell on the catch directly;
...
public final class FishListener implements Listener {
    ...
    public void onFish(PlayerFishEvent event) {
        ...
        jobsManager.processAction(player.getUniqueId(), actionKey, jobBonusMultiplier, Math.max(1, caught.getAmount()));
    }
}
